...
class MyTopology(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        las1[nwk_1].addParams(ip6=("2001:01::1/64",))
        las1[nwk_5].addParams(ip6=("2001:06::1/64",))
        las2 = self.addLink(bhs_g1, bhs_g2)
        las2[bhs_g1].addParams(ip6=("2001:02::1/64",))
        las2[bhs_g2].addParams(ip6=("2001:07::1/64",))
        las3 = self.addLink(ash_1,  ash_5)
        las3[ash_1].addParams(ip6=("2001:03::1/64",))
        las3[ash_5].addParams(ip6=("2001:08::1/64",))
        las4 = self.addLink(chi_1,  chi_5)
        las4[chi_1].addParams(ip6=("2001:04::1/64",))
        las4[chi_5].addParams(ip6=("2001:09::1/64",))

        las11 = self.addLink(nwk_1,  bhs_g1)
        las11[nwk_1].addParams(ip6=("2001:01::2/64",))
        las11[bhs_g1].addParams(ip6=("2001:02::2/64",))
        las12 = self.addLink(nwk_1,  ash_1)
        las12[nwk_1].addParams(ip6=("2001:01::3/64",))
        las12[ash_1].addParams(ip6=("2001:03::2/64",))
        las13 = self.addLink(nwk_5,  bhs_g2)
        las13[nwk_5].addParams(ip6=("2001:06::2/64",))
        las13[bhs_g2].addParams(ip6=("2001:07::2/64",))
        las14 = self.addLink(nwk_5,  ash_5)
        las14[nwk_5].addParams(ip6=("2001:06::5/64",))
        las14[ash_5].addParams(ip6=("2001:08::2/64",))

        las41 = self.addLink(chi_1,  bhs_g1, igp_metric=3)
        las41[chi_1].addParams(ip6=("2001:04::2/64",))
        las41[bhs_g1].addParams(ip6=("2001:02::3/64",))
        las42 = self.addLink(chi_1,  ash_1,  igp_metric=3)
        las42[chi_1].addParams(ip6=("2001:04::3/64",))
        las42[ash_1].addParams(ip6=("2001:03::3/64",))
        las43 = self.addLink(chi_5,  bhs_g2, igp_metric=3)
        las43[chi_5].addParams(ip6=("2001:09::2/64",))
        las43[bhs_g2].addParams(ip6=("2001:07::3/64",))
        las44 = self.addLink(chi_5,  ash_5,  igp_metric=3)
        las44[chi_5].addParams(ip6=("2001:09::3/64",))
        las44[ash_5].addParams(ip6=("2001:08::3/64",))
        # Connecting US TO EU
        las15 = self.addLink(nwk_1,  europe, igp_metric=30)#30
        las15[nwk_1].addParams(ip6=("2001:01::4/64",))
        las15[europe].addParams(ip6=("2001:05::2/64",))
        ...
        ma1[as16509_ash_1_amazon].addParams(ip6=("2001:20::1/64",))
        ma1[as16509_r1].addParams(ip6=("2001:13::3/64",))
        ma2 = self.addLink(as16509_ash_5_amazon, as16509_r2)
        ma2[as16509_ash_5_amazon].addParams(ip6=("2001:21::1/64",))
        ma2[as16509_r2].addParams(ip6=("2001:14::3/64",))
        ...
        lam1[as16509_r1].addParams(ip6=("2001:13::1/64",))
        lam1[ash_1].addParams(ip6=("2001:03::9/64",))
        lam2 = self.addLink(as16509_r1, ash_5)
        lam2[as16509_r1].addParams(ip6=("2001:13::2/64",))
        lam2[ash_5].addParams(ip6=("2001:08::5/64",))
        lam3 = self.addLink(as16509_r2, ash_1)
        lam3[as16509_r2].addParams(ip6=("2001:14::1/64",))
        lam3[ash_1].addParams(ip6=("2001:03::8/64",))
        lam4 = self.addLink(as16509_r2, ash_5)
        lam4[as16509_r2].addParams(ip6=("2001:14::2/64",))
        lam4[ash_5].addParams(ip6=("2001:08::6/64",))
        ...
        mo1[as7843_chi_1_charter].addParams(ip6=("2001:22::1/64",))
        mo1[as7843_r1].addParams(ip6=("2001:11::3/64",))
        mo2 = self.addLink(as7843_ash_1_charter, as7843_r1)
        mo2[as7843_ash_1_charter].addParams(ip6=("2001:23::1/64",))
        mo2[as7843_r1].addParams(ip6=("2001:11::4/64",))
        ...
        lach1[as7843_r1].addParams(ip6=("2001:11::1/64",))
        lach1[chi_1].addParams(ip6=("2001:04::4/64",))
        lach2 = self.addLink(as7843_r1, ash_1)
        lach2[as7843_r1].addParams(ip6=("2001:11::2/64",))
        lach2[ash_1].addParams(ip6=("2001:03::5/64",))
        lach3 = self.addLink(as7843_r2, chi_1)
        lach3[as7843_r2].addParams(ip6=("2001:80::2/64",))
        lach3[chi_1].addParams(ip6=("2001:04::5/64",))
        lach4 = self.addLink(as7843_r2, ash_1)
        lach4[as7843_r2].addParams(ip6=("2001:80::3/64",))
        lach4[ash_1].addParams(ip6=("2001:03::6/64",))
        ...
        ta1[as1299_nwk_1_telia].addParams(ip6=("2001:24::1/64",))
        ta1[as1299_r1].addParams(ip6=("2001:70::3/64",))
        ta2 = self.addLink(as1299_nwk_5_telia, as1299_r1)
        ta2[as1299_nwk_5_telia].addParams(ip6=("2001:25::1/64",))
        ta2[as1299_r1].addParams(ip6=("2001:70::4/64",))
        ta3 = self.addLink(as1299_chi_5_telia, as1299_r2)
        ta3[as1299_chi_5_telia].addParams(ip6=("2001:26::1/64",))
        ta3[as1299_r2].addParams(ip6=("2001:71::3/64",))
        ta4 = self.addLink(as1299_ash_5_telia, as1299_r2)
        ta4[as1299_ash_5_telia].addParams(ip6=("2001:27::1/64",))
        ta4[as1299_r2].addParams(ip6=("2001:71::4/64",))
        ...
        lok1[as1299_r1].addParams(ip6=("2001:70::6/64",))
        lok1[nwk_1].addParams(ip6=("2001:01::5/64",))
        lok2 = self.addLink(as1299_r1, nwk_5)
        lok2[as1299_r1].addParams(ip6=("2001:70::7/64",))
        lok2[nwk_5].addParams(ip6=("2001:06::30/64",))
        lok3 = self.addLink(as1299_r2, chi_5)
        lok3[as1299_r2].addParams(ip6=("2001:71::6/64",))
        lok3[chi_5].addParams(ip6=("2001:09::4/64",))
        lok4 = self.addLink(as1299_r2, ash_5)
        lok4[as1299_r2].addParams(ip6=("2001:71::7/64",))
        lok4[ash_5].addParams(ip6=("2001:08::7/64",))
        ...
        to1[as174_nwk_1_cogent].addParams(ip6=("2001:28::1/64",))
        to1[as174_r1].addParams(ip6=("2001:17::5/64",))
        to2 = self.addLink(as174_nwk_5_cogent, as174_r1)
        to2[as174_nwk_5_cogent].addParams(ip6=("2001:29::1/64",))
        to2[as174_r1].addParams(ip6=("2001:17::6/64",))
        to3 = self.addLink(as174_chi_1_cogent, as174_r1)
        to3[as174_chi_1_cogent].addParams(ip6=("2001:30::1/64",))
        to3[as174_r1].addParams(ip6=("2001:17::7/64",))
        to4 = self.addLink(as174_chi_5_cogent, as174_r1)
        to4[as174_chi_5_cogent].addParams(ip6=("2001:31::1/64",))
        to4[as174_r1].addParams(ip6=("2001:17::8/64",))
        to5 = self.addLink(as174_ash_1_cogent, as174_r2)
        to5[as174_ash_1_cogent].addParams(ip6=("2001:32::1/64",))
        to5[as174_r2].addParams(ip6=("2001:18::3/64",))
        to6 = self.addLink(as174_ash_5_cogent, as174_r2)
        to6[as174_ash_5_cogent].addParams(ip6=("2001:33::1/64",))
        to6[as174_r2].addParams(ip6=("2001:18::4/64",))
        ...
        lom1[as174_r1].addParams(ip6=("2001:17::1/64",))
        lom1[nwk_1].addParams(ip6=("2001:01::7/64",))
        lom2 = self.addLink(as174_r1,nwk_5)
        lom2[as174_r1].addParams(ip6=("2001:17::2/64",))
        lom2[nwk_5].addParams(ip6=("2001:06::7/64",))
        lom3 = self.addLink(as174_r1,chi_1)
        lom3[as174_r1].addParams(ip6=("2001:17::3/64",))
        lom3[chi_1].addParams(ip6=("2001:04::7/64",))
        lom4 = self.addLink(as174_r1,chi_5)
        lom4[as174_r1].addParams(ip6=("2001:17::4/64",))
        lom4[chi_5].addParams(ip6=("2001:09::6/64",))
        lom5 = self.addLink(as174_r2,ash_1)
        lom5[as174_r2].addParams(ip6=("2001:18::1/64",))
        lom5[ash_1].addParams(ip6=("2001:03::7/64",))
        lom6 = self.addLink(as174_r2,ash_5)
        lom6[as174_r2].addParams(ip6=("2001:18::2/64",))
        lom6[ash_5].addParams(ip6=("2001:08::8/64",))
        ...
        ti1[as3356_nwk_5_level3].addParams(ip6=("2001:34::1/64",))
        ti1[as3356_r1].addParams(ip6=("2001:15::3/64",))
        ti2 = self.addLink(as3356_nwk_1_level3, as3356_r1)
        ti2[as3356_nwk_1_level3].addParams(ip6=("2001:35::1/64",))
        ti2[as3356_r1].addParams(ip6=("2001:15::4/64",))
        ti3 = self.addLink(as3356_chi_1_level3, as3356_r2)
        ti3[as3356_chi_1_level3].addParams(ip6=("2001:36::1/64",))
        ti3[as3356_r2].addParams(ip6=("2001:16::3/64",))
        ti4 = self.addLink(as3356_chi_5_level3, as3356_r2)
        ti4[as3356_chi_5_level3].addParams(ip6=("2001:37::1/64",))
        ti4[as3356_r2].addParams(ip6=("2001:16::4/64",))
        ti5 = self.addLink(as3356_r1, as3356_r2)
        ti5[as3356_r1].addParams(ip6=("2001:15::5/64",))
        ti5[as3356_r2].addParams(ip6=("2001:16::5/64",))
        ...
        lou1[as3356_r1].addParams(ip6=("2001:15::1/64",))
        lou1[nwk_1].addParams(ip6=("2001:01::6/64",))
        lou2 = self.addLink(as3356_r1,nwk_5)
        lou2[as3356_r1].addParams(ip6=("2001:15::2/64",))
        lou2[nwk_5].addParams(ip6=("2001:06::6/64",))
        lou3 = self.addLink(as3356_r2,chi_1)
        lou3[as3356_r2].addParams(ip6=("2001:16::1/64",))
        lou3[chi_1].addParams(ip6=("2001:04::6/64",))
        lou4 = self.addLink(as3356_r2,chi_5)
        lou4[as3356_r2].addParams(ip6=("2001:16::2/64",))
        lou4[chi_5].addParams(ip6=("2001:09::5/64",))
        # Added an eBGP session for each datacenter region for redundancy
